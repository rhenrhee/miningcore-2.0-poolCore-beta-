...
CREATE INDEX IDX_POOLSTATS_POOL_CREATED_HOUR on poolstats(poolid, date_trunc('minute',created));
...
CREATE INDEX IDX_MINERSTATS_POOL_MINER_CREATED_MINUTE on minerstats(poolid, miner, date_trunc('minute',created));
