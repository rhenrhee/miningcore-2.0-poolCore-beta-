...
using CorePool.Blockchain.Cryptonote.Configuration;
using CorePool.Blockchain.Cryptonote.DaemonRequests;
using CorePool.Blockchain.Cryptonote.DaemonResponses;
using CorePool.Blockchain.Cryptonote.StratumRequests;
using CorePool.Configuration;
using CorePool.DaemonInterface;
...
namespace CorePool.Blockchain.Cryptonote
{
    public class CryptonoteJobManager : JobManagerBase<CryptonoteJob>
    {
        ...
        {
            // Donation to PoolCore development
