...
using CorePool.Blockchain.Equihash.Configuration;
using CorePool.Blockchain.Equihash.DaemonRequests;
...
using IBlockRepository = CorePool.Persistence.Repositories.IBlockRepository;
